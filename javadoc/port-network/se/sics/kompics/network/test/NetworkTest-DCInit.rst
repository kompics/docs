...
.. java:type:: public static class DCInit extends Init<DCComponent>
...
.. java:constructor:: public DCInit(TestAddress self, TestAddress[] fakeNodes)
   :outertype: NetworkTest.DCInit
